...
class _RoundedBackgroundTextFieldState extends State<RoundedBackgroundTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    final fontSize = (widget.style?.fontSize ?? defaultTextStyle.style.fontSize ?? 16);
    ...
    return Stack(
      ...
      children: [
        if (textController.text.isNotEmpty)
          ...
          Text(
            widget.hint!,
            style: (widget.hintStyle ?? TextStyle(color: theme.hintColor)).copyWith(
              fontSize: fontSize,
        ...
        EditableText(
          ...
          textAlign: widget.textAlign,
          maxLines:
              null, // This affects the height of the field itself and does not limit the number of lines that can be entered into the field
